...
While reviewing the list of our worst-performing methods, I noticed something curious; one function in particular, `IdentityHashMapIterator.hasNext`, was using about 0.6% of CPU cycles. This caught my attention because the exchange doesn’t ubiquitously use this specific implementation of `Map`.
